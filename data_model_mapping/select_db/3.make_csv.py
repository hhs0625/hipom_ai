...
data_mapping_file_path = 'select_db/data_mapping_normal.csv'  # Adjust this path to your actual file location
...
# Add 'mapping_count' field
mapping_counts = data_mapping.groupby(['thing', 'property']).size().reset_index(name='mapping_count')
merged_data = data_mapping.merge(mapping_counts, on=['thing', 'property'])
...
merged_data = merged_data.drop(columns=fields_to_remove)

# Save the updated DataFrame to a new CSV file
output_file_path = 'select_db/test.csv'
...
mdm_true_output_file_path = 'select_db/data_mapping_mdm.csv'
